	...
	return (
		<>
			{view === 'grid' ? (
				<div
					key={todo.id}
					className={`grid grid-cols-12 border bg-white ring-offset-1 ring-slate-300 hover:ring-2 cursor-pointer relative py-[2px] m-2 px-2 rounded-lg select-none drop-shadow-sm transition-all duration-100`}
					style={{
