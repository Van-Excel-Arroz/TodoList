...
export default function RightSidebarFooter({ creationDate, todoId }: RightSidebarFooterProps) {
	return (
		<div className="absolute border-t-2 border-slate-200 bottom-0 left-0 w-full h-20 pr-6 pl-4 bg-slate-100 flex items-center justify-between">
			...
			<button className="p-1 rounded-md hover:bg-slate-200 active:bg-slate-200 text-slate-600">
				<Trash2 />
			</button>
		</div>
	);
